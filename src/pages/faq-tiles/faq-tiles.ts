...
grid: Array<Array<{Key:string, Title: string, CssClass:string, data:Array<{title: string, details: string, icon: string, showDetails: boolean}>}>>; //array of arrays
...
this.grid[0][0] = {Key: "BillsPaymentFaq",  Title: "Bills and Payments", CssClass:"square square_violet",data:[]};

this.grid[0][0].data.push({
...
this.grid[0][1] = {Key: "Insurance", Title: "Insurance", CssClass:"square square_green", data:[]};

this.grid[1] = Array(2);


this.grid[1][0] = {Key: "TestResults", Title: "Test Results", CssClass:"square square_blue",data:[]};
this.grid[1][1] = {Key: "Registration", Title: "Registration", CssClass:"square square_reddish",data:[]};

this.grid[2] = Array(2);

this.grid[2][0] = {Key: "Login",  Title: "Login", CssClass:"square square_yellowish",data:[]};
this.grid[2][1] = {Key: "GeneralQuestion", Title: "General Questions", CssClass:"square square_red",data:[]};
